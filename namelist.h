...
private:
   ...
   char buf[BUF_SIZE];
   int bsize;
   static char start_tag; // Character to mark start of NList in file
...
public:
   ...
   NList_Entry* AddEntry(char* n, int* ptr, int v = 0);
   ...
   NList_Entry* AddEntry(char* n, char* ptr, char* v = "%s");
   ...
   void pack_nls(CBuffer *buf);
   void unpack_nls(CBuffer *buf);
